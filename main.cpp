...
int main() {
	...
	try {
		SearchServer search_server("и в на"s);
		search_server.AddDocument(0, "пушистый кот и модный ошейник"s, DocumentStatus::ACTUAL, { 1, 2 });
		search_server.AddDocument(1, "пушистый пёс и модный иван-чай"s, DocumentStatus::ACTUAL, { 1, 2 });
	...
	try {
		SearchServer search_server("и в на"s);
		search_server.AddDocument(0, "пушистый кот и модный ошейник"s, DocumentStatus::ACTUAL, { 1, 2 });
		search_server.AddDocument(1, "пушистый пёс и модный кот"s, DocumentStatus::ACTUAL, { 1, 2 });
